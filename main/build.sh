...
g++ src/OGLMain.cpp src/utils/GLShaders.cpp src/utils/GLLog.cpp src/utils/common.cpp src/utils/Noise.cpp -g -w -lX11 -lGL -lGLEW -lSOIL -lm -lalut -lopenal -lpthread
