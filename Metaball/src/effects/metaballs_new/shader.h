...
namespace graphics
{
    ...
    public:
        ...
        void uniform_vec2(const std::string& name, const vmath::vec2& value) const
        {
        ...
        void uniform_vec3(const std::string& name, const vmath::vec3& value) const
        {
        ...
        void uniform_vec4(const std::string& name, const vmath::vec4& value) const
        {
        ...
        void uniform_mat2(const std::string& name, const vmath::mat2& mat) const
        {
            glUniformMatrix2fv(glGetUniformLocation(program_id, name.c_str()), 1, GL_FALSE, &mat[0][0]);
        }

        void uniform_mat3(const std::string& name, const vmath::mat3& mat) const
        {
            glUniformMatrix3fv(glGetUniformLocation(program_id, name.c_str()), 1, GL_FALSE, &mat[0][0]);
        }

        void uniform_mat4(const std::string& name, const vmath::mat4& mat) const
        {
